...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center
      ...
      .col-auto
        a.anexo.mb-4(:href="obtenerLink('/downloads/sintesis_vf.pdf')" target="_blank")
          .anexo__icono
